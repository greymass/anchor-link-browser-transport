...
const accountCreationStylesText = `
    .%prefix% iframe-container {
        width: 400px;
        height: 500px;
        border-radius: 10px;
    }
...
export class AccountCreation {
    ...
    showDialog() {
        ...
        const iframeSrc = `https://create.anchor.link?iframe=true&skip_intro=true&supported_chains=${this.supportedChains}`
    ...
    private setupElements() {
        ...
        if (this.injectStyles && !this.styleEl) {
            ...
            let css = accountCreationStylesText.replace(/%prefix%/g, this.classPrefix)
