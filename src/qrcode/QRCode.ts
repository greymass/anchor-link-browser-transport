...
export default function QRCode(this: any, typeNumber, errorCorrectLevel) {
...
QRCode.createData = function (typeNumber: any, errorCorrectLevel: any, dataList: string | any[]) {
...
QRCode.createBytes = function (buffer: {buffer: number[]}, rsBlocks: string | any[]) {
    var offset = 0
